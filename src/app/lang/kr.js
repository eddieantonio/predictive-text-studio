  ...
  page: {
    ...
    privacy: {
      ...
      introduction: {
        title: "소개",
        head: [
          '이 개인 정보 보호 정책 ("개인 정보 보호 정책")은 Predictive Text Studio (이하 "당사"또는 "당사"라고도 함)에서 제공하는 웹 사이트 및 제품의 사용에 적용됩니다.',
          '본 개인 정보 보호 정책은 당사가 제공하는 모든 서비스 및 기타 제품, 소프트웨어 및 웹 사이트 및 그 콘텐츠와 관련된 기타 온라인 기능 (이하 "서비스")에 적용되고 효력이 있습니다.',
          "If you have any questions or comments about this Privacy Policy, please contact us at",
          '우리는 귀하의 개인 정보를 보호하고 존중하기 위해 최선을 다하고 있습니다. 개인 정보 보호 정책은 당사가 귀하로부터 수집 한 개인 정보가 당사 또는 당사를 대신하여 처리되는 근거를 설명합니다. 이러한 서비스를 통해 귀하가 제공하는 개인 데이터가 처리되는 목적 또는 수단을 결정하는 경우 당사는 "관리자"입니다. 이러한 서비스를 통해 제공하는 개인 데이터가 처리되는 목적이나 수단을 결정하는 경우 귀하는 "관리자"입니다. 우리는 일반 데이터 보호 규정 2016/679를 포함하여 적절하고 적용 가능한 데이터 보호법을 준수합니다.',
